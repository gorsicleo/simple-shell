...
/**
 * Demo program for demonstrating my shell. Consists of single function (main)
 * that creates and runs shell.
 * 
 * @author gorsicleo
 *
 */
public class MyShell {
	...
	/**
	 * Method creates new environment and runs in loop until user terminates loop
	 * with exit command.
	 * 
